...
<head>
  <link id="ico" href="<?php echo base_url(); ?>/plantilla/dist/img/bankey.png" rel="shortcut icon" type="image/vnd.microsoft.icon" />
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>plantilla/plugins/daterangepicker/daterangepicker.js"></script>
    <link rel="stylesheet" href="<?php echo base_url(); ?>plantilla/plugins/daterangepicker/daterangepicker-bs3.css"></link>

    <script type="text/javascript" src="<?php echo base_url(); ?>plantilla/js/jquery-ui.js" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>js/jquery-ui.js" type="text/javascript"></script>
    <script type="text/javascript">
        $.getScript('<?php echo base_url(); ?>plantilla/js/shared/Util.js');
