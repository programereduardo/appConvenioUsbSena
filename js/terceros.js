            ...
            if (respuesta.success === true) {
              ...
              for (var i = 0; i < cant; i++) {
                ...
                componenteListado.append(modelFila.format(
                  datos[i]["cli_id"],//0
                  datos[i]["cli_identificacion"],//1
                  datos[i]["cli_pnombre"],//2
                  datos[i]["cli_snombre"],//3
                  datos[i]["cli_papellido"],//4
                  datos[i]["cli_sapellido"],//5
                  datos[i]["cli_direccionreside"],//6
                  datos[i]["cli_direcciontrabajo"],//7
                  datos[i]["cli_correo"],//8
                  datos[i]["cli_telefono1"],//9
                  datos[i]["cli_telefono2"]//10
                ));
              }
              }
  ...
  if (error === true) {
    ...
    if (val == '1') {
      ...
      if (estado === false) {
        ...
        $.ajax({
          url: controlador+'/guardar_clientes',
          type: 'POST',
          data: fd,
